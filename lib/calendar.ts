...
export const HOLIDAYS_2026: Holiday[] = [
  ...
  { date: '2026-02-13', description: 'Carnaval (Sexta)' },
  { date: '2026-02-14', description: 'Carnaval (Sábado)' },
  { date: '2026-02-15', description: 'Carnaval (Domingo)' },
  { date: '2026-02-16', description: 'Carnaval (Segunda)' },
  { date: '2026-02-17', description: 'Carnaval' },
  { date: '2026-02-18', description: 'Quarta-feira de Cinzas' },
...
export const HOLIDAYS_2027: Holiday[] = [
  ...
  { date: '2027-02-05', description: 'Carnaval (Sexta)' },
  { date: '2027-02-06', description: 'Carnaval (Sábado)' },
  { date: '2027-02-07', description: 'Carnaval (Domingo)' },
  { date: '2027-02-08', description: 'Carnaval (Segunda)' },
  { date: '2027-02-09', description: 'Carnaval' },
  { date: '2027-02-10', description: 'Quarta-feira de Cinzas' },
...
export function getHolidaysForYear(year: number): Holiday[] {
  ...
  const fixed = [
    ...
    { month: 12, day: 31, desc: 'Véspera de Ano Novo' },
  ];
  ...
  // Carnaval block: Friday to Wednesday (relative to Tuesday)
  const carnavalDays = [
  ...
  carnavalDays.forEach(day => {
    holidays.push({ 
      date: formatDate(addDaysToDate(carnavalTerca, day.offset)), 
