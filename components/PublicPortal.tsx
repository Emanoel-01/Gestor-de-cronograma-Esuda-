...
export function PublicPortal({ 
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="text-center md:text-left space-y-3">
            ...
            <p className="text-slate-400 text-lg font-bold uppercase tracking-widest">
              Pós-Graduações em Engenharia e Arquitetura
            </p>
          ...
          <div className="flex items-center gap-4">
            ...
            {user ? (
              <div className="flex items-center gap-4 bg-slate-800 p-2 pr-4 rounded-lg border border-slate-700">
                ...
                <button 
                  onClick={logout} 
                  className="text-xs font-black hover:text-amber-500 uppercase tracking-widest transition-colors cursor-pointer"
                >
                  Sair
                </button>
              </div>
              ...
              >
                <div className="h-48 bg-slate-100 relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/40 to-transparent flex items-end p-6">
                    <h3 className="text-white text-xl font-black leading-tight uppercase tracking-tighter group-hover:text-amber-500 transition-colors">
                      {course.name}
                    </h3>
                  </div>
                </div>
                ...
                >
                  <div className="space-y-6">
                    <div className="flex justify-between items-start">
                      ...
                      <span className="text-[10px] font-black text-amber-600 bg-amber-50 px-3 py-1.5 rounded uppercase tracking-widest border border-amber-100">
                        Status: Ativo
                      </span>
                    </div>
                    <div>
                      <h3 className="text-2xl font-black text-slate-900 group-hover:text-amber-600 transition-colors uppercase tracking-tighter leading-tight">
                        {schedule.className}
                      </h3>
      ...
      {/* Public Teacher Registration Form */}
      <AnimatePresence>
        {isRegistering && (
